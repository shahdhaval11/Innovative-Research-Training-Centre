...
export const EXPERTISE = [
  {
    ...
    desc: "End-to-end guidance from research problem formulation through final submission, including chapter reviews and formatting.",
    stat: "500+ theses guided",
  },
  {
    icon: "📊",
    title: "Statistical & Data Analysis",
    desc: "Advanced support in SPSS, R, Python, and NVivo for both quantitative and qualitative data interpretation.",
    stat: "98% analysis accuracy",
  },
  {
    icon: "📰",
    title: "Research Publication",
    desc: "Assistance getting your work published in Scopus, UGC-listed, and Web of Science indexed journals.",
    stat: "350+ papers published",
  },
  {
    icon: "🔬",
    title: "Research Design",
    desc: "Expert support in designing robust research frameworks — selecting methodology, sampling strategy, and instruments.",
    stat: "15+ disciplines covered",
  },
  {
    icon: "✏️",
    title: "Academic Writing & Editing",
    desc: "Professional editing for grammar, clarity, coherence, and adherence to international academic writing standards.",
    stat: "1200+ documents edited",
  },
  {
    icon: "🤝",
    title: "One-on-One Mentorship",
    desc: "Personalised mentoring sessions that adapt to each student's unique academic situation, timeline, and goals.",
